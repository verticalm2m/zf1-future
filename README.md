...
# Zend Framework 1 now for PHP 8.5!
### Classic ZF1 Reborn
...
Framework is tested and compatible with PHP versions 8.1 to 8.5.
...
The ZF1 community has been hard at work updating Zend Framework with all of the latest features of PHP 8.1 through 8.5.
...
`composer require verticalm2m/zf1-future` https://packagist.org/packages/verticalm2m/zf1-future  

# System Requirements
ZF1 Future runs on PHP 8.1 to 8.5! (see composer.json)
...
*  [ZF1 Extras Future](https://github.com/verticalm2m/zf1-extras-future)
...
* ``Bootstrap error: Unable to resolve plugin "useragent"; no corresponding plugin with that name``  
   See comments in: https://github.com/verticalm2m/zf1-future/issues/92
